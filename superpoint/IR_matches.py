...
if __name__ == '__main__':
    ...
    for i in [0]:
        for j in range(1, no_images):
            ...
            cv2.imwrite("/home/thamilchelvan.a/NUFRL/results/SuperPoint_moving/match00" + str(j) + ".jpg",
                        matched_img)
            ...
            cv2.imwrite("/home/thamilchelvan.a/NUFRL/results/IRPoint_moving/match00" + str(j) + ".jpg",
                        matched_img)
            ...
            cv2.imwrite("/home/thamilchelvan.a/NUFRL/results/SIFT_moving/match00" + str(j) + ".jpg",
                        sift_matched_img)
        ...
        fig.autofmt_xdate()
        plt.plot(temporal_gap, no_matches_SIFT / total, 'r-', temporal_gap, no_matches_SP / total, 'b-', temporal_gap,
                 no_matches_IP / total, 'g-')
